...
public class MainApp extends Application {
    ...
    public MainApp() throws IOException {
    	...
    	newPersonData.add(new Person("89039076470","124.174.698.234",LocalDateTime.of(2015, 4, 16, 15, 30)));
    	newPersonData.add(new Person("89325197769","24.74.8.24",LocalDateTime.of(2015, 4, 16, 12, 30)));
    	newPersonData.add(new Person("89122849021","124.174.84.254",LocalDateTime.of(2015, 4, 21, 18, 00)));
